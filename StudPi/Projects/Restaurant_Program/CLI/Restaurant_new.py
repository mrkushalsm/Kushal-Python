...
def starters():
    ...
    if choice == 1:
        menu_dict["starters"][1]["Spring Rolls"]["Quantity"] += quantity
    elif choice == 2:
        menu_dict["starters"][2]["French Onion Soup"]["Quantity"] += quantity
    elif choice == 3:
        menu_dict["starters"][3]["Tomato Bruschetta"]["Quantity"] += quantity
    elif choice == 4:
        menu_dict["starters"][4]["Caesar Salad"]["Quantity"] += quantity
    elif choice == 0:
        menu()
    starters()
...
def main_course():
    ...
    quantity = int(input("Enter the quantity: "))
    if choice == 1:
        menu_dict["main_course"][1]["Grilled Salmon with Dilled Sauce"]["Quantity"] += quantity
    elif choice == 2:
        menu_dict["main_course"][2]["Roast Beef with Vegetables"]["Quantity"] += quantity
    elif choice == 3:
        menu_dict["main_course"][3]["Chicken and Mushroom Pie"]["Quantity"] += quantity
    elif choice == 4:
        menu_dict["main_course"][4]["MarraKesh Vegetarian Curry"]["Quantity"] += quantity
    elif choice == 5:
        menu_dict["main_course"][5]["Eggplant Lasagne"]["Quantity"] += quantity
    elif choice == 0:
        menu()
    main_course()
...
def desserts():
    ...
    quantity = int(input("Enter the quantity: "))
    if choice == 1:
        menu_dict["desserts"][1]["Apple Pie with Cream"]["Quantity"] += quantity
    elif choice == 2:
        menu_dict["desserts"][2]["Lemon Meringue Pie"]["Quantity"] += quantity
    elif choice == 3:
        menu_dict["desserts"][3]["Vanilla Ice Cream"]["Quantity"] += quantity
    elif choice == 4:
        menu_dict["desserts"][4]["Crêpe Suzette"]["Quantity"] += quantity
    elif choice == 5:
        menu_dict["desserts"][5]["Fruit Salad"]["Quantity"] += quantity
    elif choice == 0:
        menu()
    desserts()
