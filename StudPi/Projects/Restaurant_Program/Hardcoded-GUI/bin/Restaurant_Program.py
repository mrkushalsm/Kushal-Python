...
def main_menu():
    ...
    main_menu_window.title("Restaurant Menu")
...
def starters(main_menu_window):
    ...
    starters_window.title("Restaurant Menu")
...
def main_course(main_menu_window):
    ...
    main_course_window.title("Restaurant Menu")
...
def desserts(main_menu_window):
    ...
    desserts_window.title("Restaurant Menu")
...
def bill_display(main_menu_window):
    ...
    bill_display_window.title("Restaurant Menu")
...
def end_program(window):
    ...
    goodbye_window.title("Restaurant program")
